...
(1, 'Urban Standard', '101', 'standard', 2, 'queen', 89.00, 
 'A cozy sanctuary in the heart of Batam. The Urban Standard room offers everything you need for a comfortable stay, with warm ambient lighting, soft linens, and a peaceful urban atmosphere.',
 ARRAY['Air Conditioning', 'Flat-screen TV', 'Free Wi-Fi', 'Hair Dryer', 'Desk', 'City View'],
...
(3, 'Executive Deluxe', '201', 'deluxe', 2, 'king', 129.00, 
 'Step up to the Executive Deluxe for an elevated experience. Featuring a plush king bed, premium linens, and a private balcony with cityscape views, this room blends comfort with modern urban luxury.',
 ARRAY['Air Conditioning', 'Flat-screen TV', 'Free Wi-Fi', 'Mini Bar', 'Room Safe', 'Hair Dryer', 'Coffee Machine', 'Balcony', 'City View'],
...
(5, 'Skyline Suite', '301', 'suite', 4, 'king', 199.00, 
 'The Skyline Suite is our signature accommodation, featuring a separate living area, king bedroom, and panoramic skyline views. Perfect for families or extended stays, with all the comforts of home and boutique hotel luxury.',
 ARRAY['Air Conditioning', 'Flat-screen TV', 'Free Wi-Fi', 'Mini Bar', 'Room Safe', 'Hair Dryer', 'Room Service', 'Coffee Machine', 'Balcony', 'Skyline View', 'Bathtub', 'Iron & Board'],
 ARRAY['/waminna-hotel/images/rooms/suite/suite.jpg', '/waminna-hotel/images/rooms/suite2/image.png'],
 'available', '52 m²', 'Skyline'),
